...
import game.Game;
import game.type.breakout.entities.Entity.Direction;
import game.type.breakout.entities.type.Ball;
import game.type.breakout.entities.type.Brick;
import game.type.breakout.entities.type.Player;

public class Breakout extends Game{
	public final static String ASSETS_PATH = System.getProperty("user.dir") + File.separator + "src" + File.separator 
	+ "game" +  File.separator + "type" + File.separator + "breakout" + File.separator + "assets" + File.separator;
